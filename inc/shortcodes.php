...
class Shortcodes {
  ...
  function ws_button() {
    ...
    $product_name = $product->get_name();
    $product_price = $product->get_price(); 
    $ws_uri = 'https://api.whatsapp.com/send?phone=593981516241&text=¡Hola!%20Estoy%20interesado%20en%20el%20producto%20' . $product_name . '%20que%20tiene%20un%20precio%20de%20' . $product_price . '%20dólares.';
